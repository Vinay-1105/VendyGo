...
import { ChevronLeft, ChevronRight, User, Building, MapPin, Phone, Mail, Check } from 'lucide-react';
...
export function VendorRegistration({ onComplete, onCancel }: VendorRegistrationProps) {
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-xl text-gray-600">
            Complete your registration to start trading with thousands of vendors
          </p>
        </div>
              ...
              <div className="space-y-6">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-4">
                    Product Specialties * (Select all that apply)
                  </label>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <label htmlFor="marketing" className="text-sm text-gray-700">
                      I would like to receive updates about new features, trading opportunities, and cooperative deals
                    </label>
                  </div>
                </div>
              </div>
